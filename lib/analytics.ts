...
export async function getAnalyticsOverview(): Promise<AnalyticsOverview> {
  ...
  const [views24h, views7d, views30d, articleViews30d, visitorsRaw, sessionsRaw, returningRaw, sessionStatsRaw, topArticlesRaw, topPathsRaw, landingRaw, exitRaw, referrersRaw, dailyRaw] = await Promise.all([
