...
import { FoxCursorToggle } from "./FoxCursorToggle";
...
export function SiteHeader(){return <header className="site-header reference-header"><div className="nav shell reference-nav">
  ...
  <div className="nav-actions reference-nav-actions"><FoxCursorToggle/><Link className="search-pill desktop-search" href="/search" aria-label="Search"><Search size={17}/></Link><ThemeToggle/><Link className="join reference-subscribe" href="/#newsletter"><Mail size={15}/> Subscribe</Link><MobileNav/></div>
</div></header>}
