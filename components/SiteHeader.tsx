...
export function SiteHeader(){return <header className="site-header"><div className="nav shell">
  ...
  <div className="nav-actions"><button className="search-pill" aria-label="Search"><Search size={18}/></button><ThemeToggle/><Link className="join" href="/#newsletter"><Mail size={16}/> Subscribe</Link></div>
</div></header>}
