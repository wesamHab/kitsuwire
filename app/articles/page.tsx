...
export const metadata=pageMetadata({title:"All Articles",description:"Browse all KitsuWire articles across AI, technology, software and markets.",path:"/articles"});
